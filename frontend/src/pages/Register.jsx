...
function Register() {
    ...
    const handleRegister = (e) => {
        ...
        axios.post("http://localhost:8000/api/register", {
                ...(inviteToken ? {} : { company_name: companyName, domain }),
                name,
                email,
                password,
                ...
                <div className="w-1/2 relative overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-10 z-10">
                        ...
                        <p className="text-sm text-white/50 mt-4 leading-relaxed max-w-md">
                            Join the editorial-grade recruitment platform
                            designed for high-growth organizations who value
                            talent as art.
                        </p>
                ...
                <div className="w-1/2 flex items-center justify-center px-16 py-12">
                    <div className="max-w-md w-full">
                        ...
                        <p className="text-sm text-gray-400 mt-2 mb-8">
                            {inviteToken
                                ? "You've been invited to join a team on KANDID."
